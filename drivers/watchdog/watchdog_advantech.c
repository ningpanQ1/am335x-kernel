#if defined(CONFIG_ARCH_AM335X_ADVANTECH)
...
{
printk("adv_wdt_i2c_probe advantech!!!!! \n");
	int ret;
...
printk("adv_wdt_i2c_probe advantech!!!!!1111 \n");
	i2c_set_clientdata(client, &adv_wdt);
printk("adv_wdt_i2c_probe advantech!!!!!aaaa \n");
	adv_client = client;
printk("adv_wdt_i2c_probe advantech!!!!!mmmmmm \n");
	//Setting GPIO
	gpio_wdt_en = of_get_named_gpio_flags(np, "wdt-en", 0, &flags);
printk("adv_wdt_i2c_probe advantech!!!!!nnnn gpio_wdt_en %d \n", gpio_wdt_en);
...
printk("adv_wdt_i2c_probe advantech!!!!!222 \n");
	...
	msleep(10);
	gpio_direction_output(gpio_wdt_ping, flags);
printk("adv_wdt_i2c_probe advantech!!!!!333 \n");
...
*/
printk("adv_wdt_i2c_probe advantech!!!!!444 \n");
	...
	printk("adv_wdt_i2c_probe advantech!!!!!555\n");
	if (ret == 0 )
	{
	...
	printk("adv_wdt_i2c_probe advantech!!!!!666\n");
	dev_info(&client->dev,
	...
	printk("adv_wdt_i2c_probe advantech!!!!!7777\n");
	...
	//arm_pm_restart=NULL;
#endif
printk("adv_wdt_i2c_probe advantech!!!!!  end!!! \n");
	return 0;
